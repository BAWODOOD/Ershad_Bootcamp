 ...
 * 
 * Example:
 * - Input 1 3 5 7 4 2 => [7, 7, 7, 7, 4, 2]
 * 
 * Note: The instructor's slide contains a typo, naming the function 
 * 'left_max' instead of 'right_max'.
 */
...
void left_max(int arr[],  int len, int start_position = 0)
{
    ...
    if (arr[start_position + 1] > arr[start_position])
    {
